{
  ...
  excon = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "sha256-YElyZ8mZSFTbrdmGwW1miOGF5fWHTZ0ugXeqBTh35QI=";
      type = "gem";
    };
    version = "1.2.2";
  };
  ...
  grpc = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "sha256-x8gtVjnrZN0bxOcQC1QaPYS9kO03uLmw/zGY06P6kTI=";
      type = "gem";
    };
    version = "1.67.0";
  };
  ...
  nori = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "sha256-YWbNM2lZhUdiBz4vuuiIWTgJysGz6QT0+wCTE9ciaGE=";
      type = "gem";
    };
    version = "2.7.1";
  };
  ...
  vagrant_cloud = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "sha256-htGhGigNQ/xAq0ucAkU/IdCZYwlNfBOwlv3+O9L+hx8=";
      type = "gem";
    };
    version = "3.1.2";
  };
  ...
  winrm = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "sha256-72t2fFdy0G4YYwC1BupeZa+4SZBKVR+EgqXPwqG+XQY=";
      type = "gem";
    };
    version = "2.3.9";
  };
  ...
  oauth2 = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "sha256-sh+d789S3BYQ4N+rTIaDQhc9zXB/0Vx3fZ9PBOFT9/s=";
      type = "gem";
    };
    version = "2.0.9";
  };
  faraday = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "sha256-I/ISi/XUBTOAazo/BETMohjXbQryUyDbjngr9Crgqm8=";
      type = "gem";
    };
    version = "2.12.1";
  };
  faraday-net_http = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "sha256-ofHkzWos8hWZyCIVleJ1gtmTaBmXe71AiaYB8kxk5Uo=";
      type = "gem";
    };
    version = "3.4.0";
  };
  net-http = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "sha256-7X+IIFr+A79TFCpLgd7ZHywBUi3PAwictq1Ky0ds4do=";
      type = "gem";
    };
    version = "0.5.0";
  };
  jwt = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "sha256-Vf0HzN1kxiLTaFl0jyKQ+5wRnOMLSChnUE6fEmVNamU=";
      type = "gem";
    };
    version = "2.9.3";
  };
  multi_xml = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "sha256-T84QDGivWI/5G4upCguz8EZvBskJ8hoy9JYgWRQLphs=";
      type = "gem";
    };
    version = "0.7.1";
  };
  rack = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "sha256-0/vLykPcK0PJxtffusAWZ65YZDxCzqEAE9DalwIYobE=";
      type = "gem";
    };
    version = "3.1.8";
  };
  snaky_hash = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "sha256-Gsh+wVf8/npGDoIeDNSK4eb14+CCq1IPA/Maklnb3DE=";
      type = "gem";
    };
    version = "2.0.1";
  };
  hashie = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "sha256-tdyjH+5kHPypIuiHC/ms3Vk2rMKLSQwdw8ZllDaUxUY=";
      type = "gem";
    };
    version = "2.0.1";
  };
  version_gem = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "sha256-xpdSxtapRGrSGgMGYamIuhC6BcGtJJUyMy7MfvpTRiE=";
      type = "gem";
    };
    version = "1.1.4";
  };
